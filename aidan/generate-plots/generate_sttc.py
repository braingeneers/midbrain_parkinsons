...
def randomize_raster(raster, seed=None):
    """
    Randomize a raster by redistributing the spikes.
    """
...
def process_dataset(infile, local_input_dir, local_output_dir, iterations):
    ...
    for i in range(1, iterations + 1):
        ...
        rand_raster = randomize_raster(orig_raster, seed=seed)
    ...
    dataset_dict = {
        ...
        "randomize_raster": {"sd": random_sd, "sttc": sttc_rand, "filtered": filtered_rr}
    }
